layui.use(['layer', 'table', 'ax', 'laydate'], function () {
    ...
    LoginLog.initColumn = function () {
        return [[
            ...
            {field: 'logType', align: "center", sort: true, title: '日志类型',hide:true},
            ...
            {field: 'method', align: "center", sort: true, title: '方法名',hide:true},
            {field: 'createTime', align: "center", sort: true, title: '时间'},
            {field: 'regularMessage', align: "center", sort: true, title: '描述',hide:true},
