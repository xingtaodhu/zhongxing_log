            ...
            <el-tab-pane name="resultView" label="查看结果" style="text-align: center">
                ...
                <div class="algorithmCasesTable">
                    <el-table :data="filterTaskList" v-loading="algorithmCasesLoading" style="width: 100%"
                        ...
                        <el-table-column prop="algo" label="所用算法" min-width="160" align='center'></el-table-column>
                        <el-table-column prop="algoType" label="算法类型" width="140" align='center'></el-table-column>
                        <el-table-column prop="data" label="所用数据" min-width="180" align='center'></el-table-column>
                        ...
                        <el-table-column prop="operation" width="220" fixed="right" align='center'>
                ...
                <el-dialog title="评估结果" :visible.sync="resultEvaluationMethodDialog" center width="800px">
                    <el-form ref="evaluationForm" :model="evaluationForm" label-position="left" label-width="110px"
                        ...
                        <el-form-item label = "准确率">83.5</el-form-item>
                        <el-form-item label = "召回率">86.3</el-form-item>
